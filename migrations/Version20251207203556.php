 ...
 */
final class Version20251207203556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table = $schema->getTable('appartment');
        if (!$table->hasColumn('owner_id')) {
            $this->addSql('ALTER TABLE appartment ADD owner_id INT NOT NULL');
